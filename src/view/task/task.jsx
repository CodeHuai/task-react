...
import {Button, Tag, Table, Popconfirm, Modal, Input, Form, DatePicker} from "antd";
import "./task.less";
        ...
        return (<div className="wrapper">
            ...
            <div className="table-wrapper">
                <div className="tag-wrapper">
                    <Tag className="tag-size" color={'#398EEA'}>全部</Tag>
                ...
                <Modal title='新增任务' open={this.isModalOpen} onOk={this.handleOk.bind(this)}
                       onCancel={this.handleCancel.bind(this)}>
                    <Form
                        layout="vertical" initialValues={{task: '', time: ''}}
                    >
                        <Form.Item
                            label="任务描述"
                            name="task"
